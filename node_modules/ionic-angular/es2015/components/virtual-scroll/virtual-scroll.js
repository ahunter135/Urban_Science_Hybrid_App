...
export class VirtualScroll {
    ...
    ngOnChanges(changes) {
        if ('virtualScroll' in changes) {
            ...
            const /** @type {?} */ value = changes['virtualScroll'].currentValue;
    ...
    ngDoCheck() {
        ...
        const /** @type {?} */ changes = isPresent(this._differ) ? this._differ.diff(this.virtualScroll) : null;
    ...
    _stepNoChanges() {
        ...
        adjustRendered(cells, data);
        var /** @type {?} */ hasChanges = populateNodeData(data.topCell, data.bottomCell, diff > 0, cells, records, nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef);
        if (hasChanges) {
