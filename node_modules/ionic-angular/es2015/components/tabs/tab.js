...
export class Tab extends NavControllerBase {
     ...
     */
    load(opts) {
        const /** @type {?} */ segment = this._segment;
        if (segment || (!this._loaded && this.root)) {
            ...
            const /** @type {?} */ nameToUse = segment && segment.name ? segment.name : this.root;
            const /** @type {?} */ dataToUse = segment ? segment.data : this.rootParams;
