    ...
    var VirtualScroll = (function () {
        ...
        VirtualScroll.prototype.ngOnChanges = function (changes) {
            if ('virtualScroll' in changes) {
                ...
                var /** @type {?} */ value = changes['virtualScroll'].currentValue;
        ...
        VirtualScroll.prototype.ngDoCheck = function () {
            ...
            var /** @type {?} */ changes = util_1.isPresent(this._differ) ? this._differ.diff(this.virtualScroll) : null;
        ...
        VirtualScroll.prototype._stepNoChanges = function () {
            ...
            virtual_util_1.adjustRendered(cells, data);
            var /** @type {?} */ hasChanges = virtual_util_1.populateNodeData(data.topCell, data.bottomCell, diff > 0, cells, records, nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef);
            if (hasChanges) {
